...
In a later year I simplified the script so that it just shuffles a single set and has each element give to the next person. It wasn't until someone mentioned at the party "wow what is the probability that we had a perfect loop" that I realized this even had this property and I had just inadvertently fixed it. 
